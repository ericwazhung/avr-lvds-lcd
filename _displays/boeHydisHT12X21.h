...
//These values stolen from v66.51-64
...
//  rate...
	  ...
	  (defined(BLUE_VERT_BAR) && BLUE_VERT_BAR) || \
	  (defined(BLUE_VERT_BAR_REVERSED) && BLUE_VERT_BAR_REVERSED) || \
     (defined(BLUE_BORDER)) || \
...
#warning "V_COUNT for LVDS_PRESCALER != 8 was originally 2/3 * 768... this has been removed"
  //THIS NOTE LONG BEFORE BOE_TESTING...
 ...
 * /Users/meh/_avrProjects/LCDdirectLVDS/93-checkingProcessAgain/_displays/boeHydisHT12X21.h
 *
