...
// Luigi -> LuigiRuns...
#define LUIGI_MOTIONS	MARIO_MOTIONS

//Luigi is identical to Mario, except in color-scheme...

const static uint8_t pgm_paletteLUIGI[4*NUMPALETTES_MARIO] PROGMEM = 
{
...
const __flash sprite_t spriteLUIGI =
      {
         pgm_imageMARIO,	//Same as Mario...
         pgm_maskMARIO,
         pgm_paletteLUIGI,
         NUMPALETTES_MARIO,
         LUIGI_MOTIONS,
