...
#if (_SINE_TYPE_ == 8)
const int8_t sineTable[129] PROGMEM = {
	0, \
	2, 3, 5, 6, 8, \
	9, 11, 12, 14, 16, \
	17, 19, 20, 22, 23, \
...
const theta_t sineTable[129] PROGMEM = {
...
const int32_t sineTable[] PROGMEM = {
 ...
 * /Users/meh/_avrProjects/LCDdirectLVDS/93-checkingProcessAgain/_commonCode_localized/sineTable/0.99/sineTable.c
 *
