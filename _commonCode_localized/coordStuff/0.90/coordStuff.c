...
//@@@ It would probably be wiser to just do one limit function
//    with a larger datatype...
//    (unless selectively compiling these)
//    since most cases (?) are one-time-only tests
//    that needn't be particularly fast...?
 ...
 * /Users/meh/_avrProjects/LCDdirectLVDS/68-backToLTN/_commonCode_localized/coordStuff/0.90/coordStuff.c
 *
