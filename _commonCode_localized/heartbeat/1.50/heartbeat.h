...
void init_heartBeat(volatile uint8_t* pin, uint8_t pinName, 
	...
	#define init_heartbeat(a,b,c) init_dmsTimer()
 #else
...
#else //HEART_REMOVED
 #if(defined(_HEART_DMS_) && _HEART_DMS_)
	#define init_heartBeat() init_dmsTimer()
 #else
...
#else	//HEART_REMOVED
#define getHeartRate() ZERO8_FN() //(0)
#endif
#endif
...
#else	//HEART_REMOVED
#define heartPinInputPoll() ZERO8_FN()
#endif
#endif
 ...
 * /Users/meh/_avrProjects/LCDdirectLVDS/93-checkingProcessAgain/_commonCode_localized/heartbeat/1.50/heartbeat.h
 *
